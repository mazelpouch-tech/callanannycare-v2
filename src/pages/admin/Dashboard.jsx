...
function AreaChart({ data, width = 600, height = 220, color = "#cd6845", id = "area" }) {
...
function BarChart({ data, width = 600, height = 220, colors }) {
...
function MiniSparkline({ data, width = 80, height = 28, color = "#cd6845" }) {
  if (!data || data.length < 2) return null;
