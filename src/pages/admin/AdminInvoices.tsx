  ...
  <div class="body-content">
    <div class="addresses">
      ...
      <div class="addr">
        ...
        ${inv.billedTo ? `<div class="addr-line" style="margin-top:4px;"><strong>Client:</strong> ${inv.clientName || "N/A"}</div>` : ""}
  ...
  <div class="body-content">
    <div class="addresses">
      ...
      <div class="addr">
        ...
        ${group.bookings[0]?.billedTo ? `<div class="addr-line" style="margin-top:4px;"><strong>Client:</strong> ${group.clientName}</div>` : ""}
                ...
                <div key={inv.id} className={`px-5 py-4 space-y-3 ${selectedIds.has(inv.id) ? "bg-primary/5" : ""}`}>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      {inv.billedTo && <p className="text-xs text-muted-foreground">Client: {inv.clientName}</p>}
                      <p className="text-xs text-muted-foreground">{inv.clientEmail || ""}</p>
                    </div>
