  ...
  <div class="body-content">
    <div class="addresses">
      ...
      <div class="addr">
        ...
        ${inv.billedTo ? `<div class="addr-line" style="margin-top:6px;font-style:italic;color:#666;">Billed to: ${inv.billedTo}</div>` : ""}
      </div>
    </div>
  ...
  <div class="body-content">
    <div class="addresses">
      ...
      <div class="addr">
        ...
        ${group.bookings[0]?.billedTo ? `<div class="addr-line" style="margin-top:6px;font-style:italic;color:#666;">Billed to: ${group.bookings[0].billedTo}</div>` : ""}
      </div>
    </div>
                ...
                <div key={inv.id} className={`px-5 py-4 space-y-3 ${selectedIds.has(inv.id) ? "bg-primary/5" : ""}`}>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      {inv.billedTo && <p className="text-xs text-muted-foreground italic">Billed to: {inv.billedTo}</p>}
                      <p className="text-xs text-muted-foreground">{inv.clientEmail || ""}</p>
                    </div>
